...
├── apps/                # 내장 앱 16개 (284개 커맨드)
│   ├── sys/   var/   io/   flow/   exec/   event/   math/   shell/
│   ├── str/   time/  log/  list/   map/    net/     file/   debug/
├── docs/                # 상세 문서
│   ├── architecture.md      # 아키텍처 심층 분석
│   ├── app-development.md   # 앱 개발 가이드
│   ├── command-reference.md # 전체 커맨드 레퍼런스 (284개)
...
| debug | 12 | inspect, typeof, dump, vars, stack, assert, assert_eq, assert_ne, time, bench, echo, trace |
